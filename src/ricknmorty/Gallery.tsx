            ...
            <button className='button' onClick={() => setPage('1')}>Seite 1</button>
            {
                errorMessage
                    ...
                    <div className='page-button-wrapper'>
                        {siteInfo.prev && <button onClick={() => {setPage(oldPage => `${parseInt(oldPage)-1}`); setSearchTerm('')}}
                                                  className='button' data-testid='page-button-back'>&lt;&lt;</button>}
                        <p className='page-indicator'>page {page}</p>
                        {siteInfo.next && <button onClick={() => {setPage(oldPage => `${parseInt(oldPage)+1}`); setSearchTerm('')}}
